...
export class ExerciseService implements OnInit {
  ...
  private myExercises: Exercise[] = [
    new Exercise(
      ...
      'https://static.strengthlevel.com/images/illustrations/sit-ups-1000x1000.jpg'
    ),
    new Exercise(
      BodyPart.core,
      2,
      ...
      'https://static.strengthlevel.com/images/illustrations/russian-twist-1000x1000.jpg'
    ),
    new Exercise(
      BodyPart.core,
      3,
    ...
    new Exercise(
      ...
      'https://static.strengthlevel.com/images/illustrations/close-grip-lat-pulldown-1000x1000.jpg'
    ),
    new Exercise(
      BodyPart.upper,
      9,
    ...
    new Exercise(
      ...
      'https://static.strengthlevel.com/images/illustrations/back-extension-1000x1000.jpg'
    ),
    new Exercise(
      BodyPart.upper,
      11,
